      ...
      <div className="flex items-center justify-between h-full p-1 sm:p-2">
        <div className="flex items-center space-x-2 sm:space-x-4">
          <div className="md:hidden">
            <AlignJustify
              className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 cursor-pointer rounded-md transition-all"
          ...
          <Link to="#" className="hidden sm:flex flex-col text-primary">
            <span className="text-xs sm:text-sm md:text-md lg:text-lg font-semibold">
              PixelMatrix Technologies Pvt. Ltd.
            </span>
            <span className="text-xs sm:text-sm md:text-md text-gray-600">
              Your trusted partner in digital transformation — because knowledge
              matters.
            </span>
          </Link>
        </div>
        <div className="flex items-center space-x-2 sm:space-x-4">
          {user && user?.name && (
            <div className="flex items-center space-x-2 sm:space-x-4">
              <div className="hidden md:block text-gray-800 text-sm md:text-md lg:text-lg font-semibold">
                {user.name}
              </div>
